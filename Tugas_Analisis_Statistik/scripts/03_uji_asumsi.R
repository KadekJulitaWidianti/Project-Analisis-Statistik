...
if(!"Pendapatan_Tahunan_Miliar_IDR" %in% names(data_bersih)) {
  stop(paste("Kolom 'Pendapatan_Tahunan_Miliar_IDR' tidak ditemukan dalam data."))
}
...
ggsave(
  filename = paste0("C:/Users/kadek/OneDrive/Documents/Semester 1/SDP//Tugas_Analisis_Statistik/results/qqplot_","Pendapatan_Tahunan_Miliar_IDR", ".png"),
  plot = qq_plot,
  width = 8,
  height = 6
)
